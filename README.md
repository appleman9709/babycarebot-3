...
- `mini_app/app_replit.py` - основное приложение
...
### 3. Запуск приложения
1. После импорта Replit автоматически установит зависимости
2. Нажмите кнопку "Run" для запуска приложения
3. Приложение будет доступно по URL, который покажет Replit

### 4. Первоначальная настройка
1. После первого запуска перейдите по адресу `/init-db` для инициализации базы данных
2. Теперь дашборд будет работать с реальными данными
